  ...
  return (
    <>
      ...
      <main className={"max-w-6xl h-[calc(100vh_-_5rem)]  mx-auto my-0  px-0 py-8 " + " flex   justify-between content-center "}>
        <section className={"max-w-2xl mt-32 " + " space-y-4"}>
          <span className='text-slate-200 font-medium text-4xl'>
            👏 Olá, Bem vindo
            </span>
          <h1 className='text-slate-200 font-dancing text-7xl'>
            Sistema de Controle Contabil em <span className='text-cyan-300 '>NextJs</span> .
          </h1>
          <p className='text-slate-200 font-medium text-2xl  '>
